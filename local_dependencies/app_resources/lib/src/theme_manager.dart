...
ThemeData getApplicationTheme({required bool isLightTheme}) {
  /**
   * Theme Data
   */
  return  isLightTheme ? ThemeData(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle:
        getLightStyle(color: ColorManager.darkGrey, fontSize: AppSizes.s8),
        labelStyle:
        getLightStyle(color: ColorManager.darkGrey, fontSize: AppSizes.s8),
        errorStyle:
        getLightStyle(color: ColorManager.redColor, fontSize: AppSizes.s8),
